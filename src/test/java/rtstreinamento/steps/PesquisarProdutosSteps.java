...
public class PesquisarProdutosSteps {
	...
	public void realizo_uma_pesquisa_pelo_produto() throws Throwable {
		paginaPesquisa.preencherCampoPesquisa("O Hobbit: A Desolação de Smaug");
	...
	public void visualizo_o_produto_pesquisado() throws Throwable {
		...
		assertEquals("O Hobbit: A Desolação de Smaug",
				paginaResultado.getTituloPrimeiroProdutoResultadoUnico());
	...
	public void que_existam_produtos_com_nomes_semelhantes() throws Throwable {
		// Não faz nada ou verifica se existem os 2 filmes Senhor dos Anéis da
		// página principal
	}
	...
	public void visualizo_os_produtos_com_nomes_semelhantes() throws Throwable {
		...
		assertEquals("Bluray - Senhor dos Anéis -  As Duas Torres",
				paginaResultado.tituloPrimeiroProdutoResultadoMultiplo());
		assertEquals("Bluray - Senhor dos Anéis - A Sociedade do Anel",
				paginaResultado.tituloSegundoProdutoResultadoMultiplo());
	...
	public void realizo_a_pesquisa_por_um_produto_indisponível()
			throws Throwable {
	...
	public void visualo_o_produto_marcado_como_indisponível() throws Throwable {
		...
		assertEquals("INDISPONÍVEL",
				paginaPesquisa.tituloIndiponivelPrimeiroProduto());
	...
	public void visualizo_uma_mensagem_dizendo_que_o_produto_não_foi_encontrado()
			throws Throwable {
		String mensagemProdutoInexistente = "Sua busca por: \"Capitão América\" não encontrou nenhum resultado";
		assertEquals(mensagemProdutoInexistente,
				paginaResultado.mensagemProdutoInexistente());
